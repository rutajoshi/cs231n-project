...
####### TINY DATASET TRAINING #########

CUDA_LAUNCH_BLOCKING=1
rm -rf /home/ubuntu/ruta/results/tiny_erus_multiclass
mkdir /home/ubuntu/ruta/results/tiny_erus_multiclass
python main.py --root_path /home/ubuntu/ruta/data \
	--video_path tiny_jpgs \
	--annotation_path /home/ubuntu/ruta/labels/tiny_split_labels/mh_01.json \
	--result_path ../results/tiny_erus_multiclass \
	--dataset erus \
	--n_classes 4 \
	--model resnet \
	--model_depth 101 \
