mkdir /home/ubuntu/data/processed_video/results_18_m75
...
mkdir /home/ubuntu/data/processed_video/results_34_m75
python main.py --root_path /home/ubuntu/data/processed_video \
        --video_path question_cropsampled \
        --annotation_path question_cropsampled/mh_01.json \
        --result_path results_34_m75 \
        --dataset mh \
        --n_classes 4 \
        --n_pretrain_classes 1039 \
...
mkdir /home/ubuntu/data/processed_video/results_50_m75
python main.py --root_path /home/ubuntu/data/processed_video \
        --video_path question_cropsampled \
        --annotation_path question_cropsampled/mh_01.json \
        --result_path results_50_m75 \
        --dataset mh \
        --n_classes 4 \
        --n_pretrain_classes 1039 \
...
mkdir /home/ubuntu/data/processed_video/results_101_m75
python main.py --root_path /home/ubuntu/data/processed_video \
        --video_path question_cropsampled \
        --annotation_path question_cropsampled/mh_01.json \
        --result_path results_101_m75 \
        --dataset mh \
        --n_classes 4 \
        --n_pretrain_classes 1039 \
...
mkdir /home/ubuntu/data/processed_video/results_152_m75
python main.py --root_path /home/ubuntu/data/processed_video \
        --video_path question_cropsampled \
        --annotation_path question_cropsampled/mh_01.json \
        --result_path results_152_m75 \
        --dataset mh \
        --n_classes 4 \
        --n_pretrain_classes 1039 \
