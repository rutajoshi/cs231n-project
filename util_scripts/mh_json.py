...
def convert_mh_csv_to_json(label_csv_path, train_csv_path, val_csv_path,
...
if __name__ == '__main__':
    ...
    for split_index in range(1, 2):
        ...
        dst_json_path = args.dst_path / 'mh_0{}.json'.format(split_index)

        convert_mh_csv_to_json(label_csv_path, train_csv_path, val_csv_path,
