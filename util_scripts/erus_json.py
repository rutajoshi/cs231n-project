...
def convert_erus_csv_to_json(label_csv_path, train_csv_path, val_csv_path, test_csv_path,
...
if __name__ == '__main__':
    ...
    for split_index in range(1, 2):
        ...
        train_csv_path = args.dir_path / 'trainlist01.txt' #.format(split_index)
        val_csv_path = args.dir_path / 'vallist01.txt' #.format(split_index)
        test_csv_path = args.dir_path / 'testlist01.txt' #.format(split_index)
        dst_json_path = args.dst_path / 'mh_01.json'.format(split_index)

        convert_erus_csv_to_json(label_csv_path, train_csv_path, val_csv_path, test_csv_path,
