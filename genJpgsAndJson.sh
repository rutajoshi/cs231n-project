...
#python -m util_scripts.generate_video_jpgs ~/small_data/nturgb/ ~/small_data/nturgb/jpg/ ntu
#python -m util_scripts.ntu_json ~/small_ntuTrainTestlist/ ~/small_data/nturgb/jpg/ ~/small_data/

python -m util_scripts.generate_video_jpgs ~/big_data/nturgb/ ~/big_data/nturgb/jpg/ ntu
python -m util_scripts.ntu_json ~/big_ntuTrainTestlist/ ~/big_data/nturgb/jpg/ ~/big_data/
